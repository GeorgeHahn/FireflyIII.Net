...
namespace FireflyIII.Api
{
    ...
    public partial class BillsApi : IBillsApi
    {
        ...
        /// <returns></returns>
        public BillsApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public BillsApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<BillSingle> localVarResponse = GetBillWithHttpInfo(id, start, end);
        ...
        {
             FireflyIII.Client.ApiResponse<BillSingle> localVarResponse = await GetBillAsyncWithHttpInfo(id, start, end);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<AttachmentArray> localVarResponse = ListAttachmentByBillWithHttpInfo(id, page);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<AttachmentArray> localVarResponse = await ListAttachmentByBillAsyncWithHttpInfo(id, page);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BillArray> localVarResponse = ListBillWithHttpInfo(page, start, end);
             return localVarResponse.Data;
        }
        ...
        /// <param name="end">A date formatted YYYY-MM-DD. If it is added to the request, Firefly III will calculate the appropriate payment and paid dates.  (optional)</param>
        /// <returns>ApiResponse of BillArray</returns>
        public FireflyIII.Client.ApiResponse< BillArray > ListBillWithHttpInfo (int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<BillArray> localVarResponse = await ListBillAsyncWithHttpInfo(page, start, end);
             return localVarResponse.Data;
        ...
        /// <param name="end">A date formatted YYYY-MM-DD. If it is added to the request, Firefly III will calculate the appropriate payment and paid dates.  (optional)</param>
        /// <returns>Task of ApiResponse (BillArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<BillArray>> ListBillAsyncWithHttpInfo (int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?))
        {
        ...
        {
             FireflyIII.Client.ApiResponse<RuleArray> localVarResponse = ListRuleByBillWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<RuleArray> localVarResponse = await ListRuleByBillAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = ListTransactionByBillWithHttpInfo(id, start, end, type);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = await ListTransactionByBillAsyncWithHttpInfo(id, start, end, type);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BillSingle> localVarResponse = StoreBillWithHttpInfo(bill);
             return localVarResponse.Data;
        }
        ...
        /// <param name="bill">JSON array or key&#x3D;value pairs with the necessary bill information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of BillSingle</returns>
        public FireflyIII.Client.ApiResponse< BillSingle > StoreBillWithHttpInfo (Bill bill)
        {
            // verify the required parameter 'bill' is set
            if (bill == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'bill' when calling BillsApi->StoreBill");
        ...
        {
             FireflyIII.Client.ApiResponse<BillSingle> localVarResponse = await StoreBillAsyncWithHttpInfo(bill);
             return localVarResponse.Data;
        ...
        /// <param name="bill">JSON array or key&#x3D;value pairs with the necessary bill information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (BillSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<BillSingle>> StoreBillAsyncWithHttpInfo (Bill bill)
        {
            // verify the required parameter 'bill' is set
            if (bill == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'bill' when calling BillsApi->StoreBill");
        ...
        {
             FireflyIII.Client.ApiResponse<BillSingle> localVarResponse = UpdateBillWithHttpInfo(id, bill);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< BillSingle > UpdateBillWithHttpInfo (int id, Bill bill)
        {
            ...
            // verify the required parameter 'bill' is set
            if (bill == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'bill' when calling BillsApi->UpdateBill");
        ...
        {
             FireflyIII.Client.ApiResponse<BillSingle> localVarResponse = await UpdateBillAsyncWithHttpInfo(id, bill);
             return localVarResponse.Data;
