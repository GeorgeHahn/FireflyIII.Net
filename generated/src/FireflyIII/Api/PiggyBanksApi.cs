...
namespace FireflyIII.Api
{
    ...
    public partial class PiggyBanksApi : IPiggyBanksApi
    {
        ...
        /// <returns></returns>
        public PiggyBanksApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public PiggyBanksApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankSingle> localVarResponse = GetPiggyBankWithHttpInfo(id);
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankSingle> localVarResponse = await GetPiggyBankAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankEventArray> localVarResponse = ListEventByPiggyBankWithHttpInfo(id, page);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankEventArray> localVarResponse = await ListEventByPiggyBankAsyncWithHttpInfo(id, page);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankArray> localVarResponse = ListPiggyBankWithHttpInfo(page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">Page number. The default pagination is 50. (optional)</param>
        /// <returns>ApiResponse of PiggyBankArray</returns>
        public FireflyIII.Client.ApiResponse< PiggyBankArray > ListPiggyBankWithHttpInfo (int? page = default(int?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankArray> localVarResponse = await ListPiggyBankAsyncWithHttpInfo(page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number. The default pagination is 50. (optional)</param>
        /// <returns>Task of ApiResponse (PiggyBankArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PiggyBankArray>> ListPiggyBankAsyncWithHttpInfo (int? page = default(int?))
        {
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankSingle> localVarResponse = StorePiggyBankWithHttpInfo(piggyBank);
             return localVarResponse.Data;
        }
        ...
        /// <param name="piggyBank">JSON array or key&#x3D;value pairs with the necessary piggy bank information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of PiggyBankSingle</returns>
        public FireflyIII.Client.ApiResponse< PiggyBankSingle > StorePiggyBankWithHttpInfo (PiggyBank piggyBank)
        {
            // verify the required parameter 'piggyBank' is set
            if (piggyBank == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'piggyBank' when calling PiggyBanksApi->StorePiggyBank");
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankSingle> localVarResponse = await StorePiggyBankAsyncWithHttpInfo(piggyBank);
             return localVarResponse.Data;
        ...
        /// <param name="piggyBank">JSON array or key&#x3D;value pairs with the necessary piggy bank information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (PiggyBankSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PiggyBankSingle>> StorePiggyBankAsyncWithHttpInfo (PiggyBank piggyBank)
        {
            // verify the required parameter 'piggyBank' is set
            if (piggyBank == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'piggyBank' when calling PiggyBanksApi->StorePiggyBank");
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankSingle> localVarResponse = UpdatePiggyBankWithHttpInfo(id, piggyBank);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< PiggyBankSingle > UpdatePiggyBankWithHttpInfo (int id, PiggyBank piggyBank)
        {
            ...
            // verify the required parameter 'piggyBank' is set
            if (piggyBank == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'piggyBank' when calling PiggyBanksApi->UpdatePiggyBank");
        ...
        {
             FireflyIII.Client.ApiResponse<PiggyBankSingle> localVarResponse = await UpdatePiggyBankAsyncWithHttpInfo(id, piggyBank);
             return localVarResponse.Data;
