...
namespace FireflyIII.Api
{
    ...
    public partial class ImportApi : IImportApi
    {
        ...
        /// <returns></returns>
        public ImportApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public ImportApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="key">The job key of an import job.</param>
        /// <returns>Task of ApiResponse (ImportJobSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<ImportJobSingle>> GetImportAsyncWithHttpInfo (string key)
        {
            // verify the required parameter 'key' is set
            if (key == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'key' when calling ImportApi->GetImport");
        ...
        /// <param name="page">Page number. The default pagination is per 50 items. (optional)</param>
        /// <returns>ApiResponse of ImportJobArray</returns>
        public FireflyIII.Client.ApiResponse< ImportJobArray > ListImportWithHttpInfo (int? page = default(int?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<ImportJobArray> localVarResponse = await ListImportAsyncWithHttpInfo(page);
             return localVarResponse.Data;
        ...
        /// <param name="type">Optional filter on the transaction type(s) returned. (optional)</param>
        /// <returns>ApiResponse of TransactionArray</returns>
        public FireflyIII.Client.ApiResponse< TransactionArray > ListTransactionByImportWithHttpInfo (string key, int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?), TransactionTypeFilter type = default(TransactionTypeFilter))
        {
            // verify the required parameter 'key' is set
            if (key == null)
