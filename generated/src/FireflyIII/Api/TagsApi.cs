...
namespace FireflyIII.Api
{
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <param name="tag">Either the tag itself or the tag ID.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public FireflyIII.Client.ApiResponse<Object> DeleteTagWithHttpInfo (string tag)
        {
        ...
        /// <param name="tag">Either the tag itself or the tag ID.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<Object>> DeleteTagAsyncWithHttpInfo (string tag)
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'tag' when calling TagsApi->DeleteTag");
        ...
        /// <param name="page">Page number (optional)</param>
        /// <returns>ApiResponse of TagSingle</returns>
        public FireflyIII.Client.ApiResponse< TagSingle > GetTagWithHttpInfo (string tag, int? page = default(int?))
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
        ...
        {
             FireflyIII.Client.ApiResponse<TagSingle> localVarResponse = await GetTagAsyncWithHttpInfo(tag, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number (optional)</param>
        /// <returns>Task of ApiResponse (TagSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<TagSingle>> GetTagAsyncWithHttpInfo (string tag, int? page = default(int?))
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'tag' when calling TagsApi->GetTag");
        ...
        /// <param name="end">A date formatted YYYY-MM-DD. </param>
        /// <returns>ApiResponse of TagCloud</returns>
        public FireflyIII.Client.ApiResponse< TagCloud > GetTagCloudWithHttpInfo (DateTime start, DateTime end)
        {
            // verify the required parameter 'start' is set
            if (start == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'start' when calling TagsApi->GetTagCloud");

            // verify the required parameter 'end' is set
            if (end == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'end' when calling TagsApi->GetTagCloud");
        ...
        {
             FireflyIII.Client.ApiResponse<TagCloud> localVarResponse = await GetTagCloudAsyncWithHttpInfo(start, end);
             return localVarResponse.Data;
        ...
        /// <param name="end">A date formatted YYYY-MM-DD. </param>
        /// <returns>Task of ApiResponse (TagCloud)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<TagCloud>> GetTagCloudAsyncWithHttpInfo (DateTime start, DateTime end)
        {
            // verify the required parameter 'start' is set
            if (start == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'start' when calling TagsApi->GetTagCloud");
        ...
        /// <param name="page">Page number (optional)</param>
        /// <returns>ApiResponse of TagArray</returns>
        public FireflyIII.Client.ApiResponse< TagArray > ListTagWithHttpInfo (int? page = default(int?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<TagArray> localVarResponse = await ListTagAsyncWithHttpInfo(page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number (optional)</param>
        /// <returns>Task of ApiResponse (TagArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<TagArray>> ListTagAsyncWithHttpInfo (int? page = default(int?))
        {
        ...
        /// <param name="type">Optional filter on the transaction type(s) returned. (optional)</param>
        /// <returns>ApiResponse of TransactionArray</returns>
        public FireflyIII.Client.ApiResponse< TransactionArray > ListTransactionByTagWithHttpInfo (string tag, int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?), TransactionTypeFilter type = default(TransactionTypeFilter))
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = await ListTransactionByTagAsyncWithHttpInfo(tag, page, start, end, type);
             return localVarResponse.Data;
        ...
        /// <param name="type">Optional filter on the transaction type(s) returned. (optional)</param>
        /// <returns>Task of ApiResponse (TransactionArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<TransactionArray>> ListTransactionByTagAsyncWithHttpInfo (string tag, int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?), TransactionTypeFilter type = default(TransactionTypeFilter))
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'tag' when calling TagsApi->ListTransactionByTag");
        ...
        /// <param name="tagModel">JSON array or key&#x3D;value pairs with the necessary tag information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of TagSingle</returns>
        public FireflyIII.Client.ApiResponse< TagSingle > StoreTagWithHttpInfo (TagModel tagModel)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<TagSingle> localVarResponse = await StoreTagAsyncWithHttpInfo(tagModel);
             return localVarResponse.Data;
        ...
        /// <param name="tagModel">JSON array or key&#x3D;value pairs with the necessary tag information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (TagSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<TagSingle>> StoreTagAsyncWithHttpInfo (TagModel tagModel)
        {
            // verify the required parameter 'tagModel' is set
            if (tagModel == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'tagModel' when calling TagsApi->StoreTag");
        ...
        /// <param name="tagModel">JSON array with updated tag information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of TagSingle</returns>
        public FireflyIII.Client.ApiResponse< TagSingle > UpdateTagWithHttpInfo (string tag, TagModel tagModel)
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
        ...
        {
             FireflyIII.Client.ApiResponse<TagSingle> localVarResponse = await UpdateTagAsyncWithHttpInfo(tag, tagModel);
             return localVarResponse.Data;
        ...
        /// <param name="tagModel">JSON array with updated tag information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (TagSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<TagSingle>> UpdateTagAsyncWithHttpInfo (string tag, TagModel tagModel)
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'tag' when calling TagsApi->UpdateTag");
