...
namespace FireflyIII.Api
{
    ...
    public partial class RuleGroupsApi : IRuleGroupsApi
    {
        ...
        /// <returns></returns>
        public RuleGroupsApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public RuleGroupsApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        public FireflyIII.Client.ApiResponse<Object> FireRuleGroupWithHttpInfo (int id, DateTime? start = default(DateTime?), DateTime? end = default(DateTime?), string accounts = default(string))
        {
            ...
            if (accounts != null)
            {
                foreach (var _kvp in FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "accounts", accounts))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupSingle> localVarResponse = GetRuleGroupWithHttpInfo(id);
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupSingle> localVarResponse = await GetRuleGroupAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<RuleArray> localVarResponse = ListRuleByGroupWithHttpInfo(id, page);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<RuleArray> localVarResponse = await ListRuleByGroupAsyncWithHttpInfo(id, page);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupArray> localVarResponse = ListRuleGroupWithHttpInfo(page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">Page number. The default pagination is 50 (optional)</param>
        /// <returns>ApiResponse of RuleGroupArray</returns>
        public FireflyIII.Client.ApiResponse< RuleGroupArray > ListRuleGroupWithHttpInfo (int? page = default(int?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupArray> localVarResponse = await ListRuleGroupAsyncWithHttpInfo(page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number. The default pagination is 50 (optional)</param>
        /// <returns>Task of ApiResponse (RuleGroupArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<RuleGroupArray>> ListRuleGroupAsyncWithHttpInfo (int? page = default(int?))
        {
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupSingle> localVarResponse = StoreRuleGroupWithHttpInfo(ruleGroup);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ruleGroup">JSON array or key&#x3D;value pairs with the necessary rule group information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of RuleGroupSingle</returns>
        public FireflyIII.Client.ApiResponse< RuleGroupSingle > StoreRuleGroupWithHttpInfo (RuleGroup ruleGroup)
        {
            // verify the required parameter 'ruleGroup' is set
            if (ruleGroup == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'ruleGroup' when calling RuleGroupsApi->StoreRuleGroup");
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupSingle> localVarResponse = await StoreRuleGroupAsyncWithHttpInfo(ruleGroup);
             return localVarResponse.Data;
        ...
        /// <param name="ruleGroup">JSON array or key&#x3D;value pairs with the necessary rule group information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (RuleGroupSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<RuleGroupSingle>> StoreRuleGroupAsyncWithHttpInfo (RuleGroup ruleGroup)
        {
            // verify the required parameter 'ruleGroup' is set
            if (ruleGroup == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'ruleGroup' when calling RuleGroupsApi->StoreRuleGroup");
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = TestRuleGroupWithHttpInfo(id, page, start, end, searchLimit, triggeredLimit, accounts);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< TransactionArray > TestRuleGroupWithHttpInfo (int id, int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?), int? searchLimit = default(int?), int? triggeredLimit = default(int?), string accounts = default(string))
        {
            ...
            if (searchLimit != null)
            {
                foreach (var _kvp in FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "search_limit", searchLimit))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            {
                foreach (var _kvp in FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "triggered_limit", triggeredLimit))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = await TestRuleGroupAsyncWithHttpInfo(id, page, start, end, searchLimit, triggeredLimit, accounts);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupSingle> localVarResponse = UpdateRuleGroupWithHttpInfo(id, ruleGroup);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< RuleGroupSingle > UpdateRuleGroupWithHttpInfo (int id, RuleGroup ruleGroup)
        {
            ...
            // verify the required parameter 'ruleGroup' is set
            if (ruleGroup == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'ruleGroup' when calling RuleGroupsApi->UpdateRuleGroup");
        ...
        {
             FireflyIII.Client.ApiResponse<RuleGroupSingle> localVarResponse = await UpdateRuleGroupAsyncWithHttpInfo(id, ruleGroup);
             return localVarResponse.Data;
