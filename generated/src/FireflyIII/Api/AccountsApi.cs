...
namespace FireflyIII.Api
{
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <returns></returns>
        public AccountsApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public FireflyIII.Client.ApiResponse< AccountSingle > StoreAccountWithHttpInfo (Account account)
        {
            ...
            if (account == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'account' when calling AccountsApi->StoreAccount");
        ...
        public FireflyIII.Client.ApiResponse< AccountSingle > UpdateAccountWithHttpInfo (int id, Account account)
        {
            ...
            // verify the required parameter 'account' is set
            if (account == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'account' when calling AccountsApi->UpdateAccount");
