...
namespace FireflyIII.Api
{
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <returns></returns>
        public UsersApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public UsersApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="page">The page number, if necessary. The default pagination is 50, so 50 users per page. (optional)</param>
        /// <returns>Task of ApiResponse (UserArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<UserArray>> ListUserAsyncWithHttpInfo (int? page = default(int?))
        {
        ...
        /// <param name="user">JSON array or key&#x3D;value pairs with the necessary user information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (UserSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<UserSingle>> StoreUserAsyncWithHttpInfo (User user)
        {
            // verify the required parameter 'user' is set
            if (user == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'user' when calling UsersApi->StoreUser");
        ...
        public FireflyIII.Client.ApiResponse< UserSingle > UpdateUserWithHttpInfo (int id, User user)
        {
            ...
            // verify the required parameter 'user' is set
            if (user == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'user' when calling UsersApi->UpdateUser");
        ...
        {
             FireflyIII.Client.ApiResponse<UserSingle> localVarResponse = await UpdateUserAsyncWithHttpInfo(id, user);
             return localVarResponse.Data;
