...
namespace FireflyIII.Api
{
    ...
    public partial class CategoriesApi : ICategoriesApi
    {
        ...
        /// <returns></returns>
        public CategoriesApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public CategoriesApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<CategorySingle> localVarResponse = GetCategoryWithHttpInfo(id);
        ...
        {
             FireflyIII.Client.ApiResponse<CategorySingle> localVarResponse = await GetCategoryAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<CategoryArray> localVarResponse = ListCategoryWithHttpInfo(page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">Page number. The default pagination is 50. (optional)</param>
        /// <returns>ApiResponse of CategoryArray</returns>
        public FireflyIII.Client.ApiResponse< CategoryArray > ListCategoryWithHttpInfo (int? page = default(int?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<CategoryArray> localVarResponse = await ListCategoryAsyncWithHttpInfo(page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number. The default pagination is 50. (optional)</param>
        /// <returns>Task of ApiResponse (CategoryArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<CategoryArray>> ListCategoryAsyncWithHttpInfo (int? page = default(int?))
        {
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = ListTransactionByCategoryWithHttpInfo(id, page, start, end, type);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = await ListTransactionByCategoryAsyncWithHttpInfo(id, page, start, end, type);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<CategorySingle> localVarResponse = StoreCategoryWithHttpInfo(category);
             return localVarResponse.Data;
        }
        ...
        /// <param name="category">JSON array or key&#x3D;value pairs with the necessary category information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of CategorySingle</returns>
        public FireflyIII.Client.ApiResponse< CategorySingle > StoreCategoryWithHttpInfo (Category category)
        {
            // verify the required parameter 'category' is set
            if (category == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'category' when calling CategoriesApi->StoreCategory");
        ...
        {
             FireflyIII.Client.ApiResponse<CategorySingle> localVarResponse = await StoreCategoryAsyncWithHttpInfo(category);
             return localVarResponse.Data;
        ...
        /// <param name="category">JSON array or key&#x3D;value pairs with the necessary category information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (CategorySingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<CategorySingle>> StoreCategoryAsyncWithHttpInfo (Category category)
        {
            // verify the required parameter 'category' is set
            if (category == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'category' when calling CategoriesApi->StoreCategory");
        ...
        {
             FireflyIII.Client.ApiResponse<CategorySingle> localVarResponse = UpdateCategoryWithHttpInfo(id, category);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< CategorySingle > UpdateCategoryWithHttpInfo (int id, Category category)
        {
            ...
            // verify the required parameter 'category' is set
            if (category == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'category' when calling CategoriesApi->UpdateCategory");
        ...
        {
             FireflyIII.Client.ApiResponse<CategorySingle> localVarResponse = await UpdateCategoryAsyncWithHttpInfo(id, category);
             return localVarResponse.Data;
