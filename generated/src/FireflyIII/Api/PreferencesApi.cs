...
namespace FireflyIII.Api
{
    ...
    public partial class PreferencesApi : IPreferencesApi
    {
        ...
        /// <returns></returns>
        public PreferencesApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public PreferencesApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<PreferenceSingle> localVarResponse = GetPreferenceWithHttpInfo(name);
        ...
        /// <param name="name">The name of the preference.</param>
        /// <returns>ApiResponse of PreferenceSingle</returns>
        public FireflyIII.Client.ApiResponse< PreferenceSingle > GetPreferenceWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'name' when calling PreferencesApi->GetPreference");
        ...
        {
             FireflyIII.Client.ApiResponse<PreferenceSingle> localVarResponse = await GetPreferenceAsyncWithHttpInfo(name);
             return localVarResponse.Data;
        ...
        /// <param name="name">The name of the preference.</param>
        /// <returns>Task of ApiResponse (PreferenceSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PreferenceSingle>> GetPreferenceAsyncWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'name' when calling PreferencesApi->GetPreference");
        ...
        {
             FireflyIII.Client.ApiResponse<PreferenceArray> localVarResponse = ListPreferenceWithHttpInfo(page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">Page number. The default pagination is 50. (optional)</param>
        /// <returns>ApiResponse of PreferenceArray</returns>
        public FireflyIII.Client.ApiResponse< PreferenceArray > ListPreferenceWithHttpInfo (int? page = default(int?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<PreferenceArray> localVarResponse = await ListPreferenceAsyncWithHttpInfo(page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number. The default pagination is 50. (optional)</param>
        /// <returns>Task of ApiResponse (PreferenceArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PreferenceArray>> ListPreferenceAsyncWithHttpInfo (int? page = default(int?))
        {
        ...
        {
             FireflyIII.Client.ApiResponse<PreferenceSingle> localVarResponse = UpdatePreferenceWithHttpInfo(name, preference);
             return localVarResponse.Data;
        }
        ...
        /// <param name="preference">JSON array or key&#x3D;value pairs with the necessary preference information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of PreferenceSingle</returns>
        public FireflyIII.Client.ApiResponse< PreferenceSingle > UpdatePreferenceWithHttpInfo (string name, Preference preference)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'name' when calling PreferencesApi->UpdatePreference");

            // verify the required parameter 'preference' is set
            if (preference == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'preference' when calling PreferencesApi->UpdatePreference");
        ...
        {
             FireflyIII.Client.ApiResponse<PreferenceSingle> localVarResponse = await UpdatePreferenceAsyncWithHttpInfo(name, preference);
             return localVarResponse.Data;
        ...
        /// <param name="preference">JSON array or key&#x3D;value pairs with the necessary preference information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (PreferenceSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PreferenceSingle>> UpdatePreferenceAsyncWithHttpInfo (string name, Preference preference)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'name' when calling PreferencesApi->UpdatePreference");
