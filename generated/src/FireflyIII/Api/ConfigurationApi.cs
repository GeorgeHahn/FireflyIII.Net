...
namespace FireflyIII.Api
{
    ...
    public partial class ConfigurationApi : IConfigurationApi
    {
        ...
        /// <returns></returns>
        public ConfigurationApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public ConfigurationApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="value">Can be a number or a boolean. This depends on the actual configuration value.</param>
        /// <returns>ApiResponse of SystemConfiguration</returns>
        public FireflyIII.Client.ApiResponse< SystemConfiguration > SetConfigurationWithHttpInfo (string name, string value)
        {
