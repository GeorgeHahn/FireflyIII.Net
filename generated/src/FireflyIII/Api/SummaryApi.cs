...
namespace FireflyIII.Api
{
    ...
    public partial class SummaryApi : ISummaryApi
    {
        ...
        /// <returns></returns>
        public SummaryApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public SummaryApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="currencyCode">A currency code like EUR or USD, to filter the result.  (optional)</param>
        /// <returns>ApiResponse of List&lt;BasicSummaryEntry&gt;</returns>
        public FireflyIII.Client.ApiResponse< List<BasicSummaryEntry> > GetBasicSummaryWithHttpInfo (DateTime start, DateTime end, string currencyCode = default(string))
        {
