...
namespace FireflyIII.Api
{
    ...
    public partial class BudgetsApi : IBudgetsApi
    {
        ...
        /// <returns></returns>
        public BudgetsApi(FireflyIII.Client.Configuration configuration)
        {
        ...
        public BudgetsApi(FireflyIII.Client.ISynchronousClient client,FireflyIII.Client.IAsynchronousClient asyncClient, FireflyIII.Client.IReadableConfiguration configuration)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetSingle> localVarResponse = GetBudgetWithHttpInfo(id, startDate, endDate);
        ...
        public FireflyIII.Client.ApiResponse< BudgetSingle > GetBudgetWithHttpInfo (int id, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?))
        {
            ...
            if (startDate != null)
            {
                foreach (var _kvp in FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "start_date", startDate))
                {
            ...
            if (endDate != null)
            {
                foreach (var _kvp in FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "end_date", endDate))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetSingle> localVarResponse = await GetBudgetAsyncWithHttpInfo(id, startDate, endDate);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitSingle> localVarResponse = GetBudgetLimitWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitSingle> localVarResponse = await GetBudgetLimitAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetArray> localVarResponse = ListBudgetWithHttpInfo(page, start, end);
             return localVarResponse.Data;
        }
        ...
        /// <param name="end">A date formatted YYYY-MM-DD, to get info on how much the user has spent. You must submit both start and end.  (optional)</param>
        /// <returns>ApiResponse of BudgetArray</returns>
        public FireflyIII.Client.ApiResponse< BudgetArray > ListBudgetWithHttpInfo (int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetArray> localVarResponse = await ListBudgetAsyncWithHttpInfo(page, start, end);
             return localVarResponse.Data;
        ...
        /// <param name="end">A date formatted YYYY-MM-DD, to get info on how much the user has spent. You must submit both start and end.  (optional)</param>
        /// <returns>Task of ApiResponse (BudgetArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<BudgetArray>> ListBudgetAsyncWithHttpInfo (int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?))
        {
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitArray> localVarResponse = ListBudgetLimitByBudgetWithHttpInfo(id, start, end);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitArray> localVarResponse = await ListBudgetLimitByBudgetAsyncWithHttpInfo(id, start, end);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = ListTransactionByBudgetWithHttpInfo(id, limit, page, start, end, type);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< TransactionArray > ListTransactionByBudgetWithHttpInfo (int id, int? limit = default(int?), int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?), TransactionTypeFilter type = default(TransactionTypeFilter))
        {
            ...
            if (limit != null)
            {
                foreach (var _kvp in FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "limit", limit))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = await ListTransactionByBudgetAsyncWithHttpInfo(id, limit, page, start, end, type);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = ListTransactionByBudgetLimitWithHttpInfo(id, page, type);
             return localVarResponse.Data;
        }
        ...
        {
             FireflyIII.Client.ApiResponse<TransactionArray> localVarResponse = await ListTransactionByBudgetLimitAsyncWithHttpInfo(id, page, type);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetSingle> localVarResponse = StoreBudgetWithHttpInfo(budget);
             return localVarResponse.Data;
        }
        ...
        /// <param name="budget">JSON array or key&#x3D;value pairs with the necessary budget information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of BudgetSingle</returns>
        public FireflyIII.Client.ApiResponse< BudgetSingle > StoreBudgetWithHttpInfo (Budget budget)
        {
            // verify the required parameter 'budget' is set
            if (budget == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'budget' when calling BudgetsApi->StoreBudget");
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetSingle> localVarResponse = await StoreBudgetAsyncWithHttpInfo(budget);
             return localVarResponse.Data;
        ...
        /// <param name="budget">JSON array or key&#x3D;value pairs with the necessary budget information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (BudgetSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<BudgetSingle>> StoreBudgetAsyncWithHttpInfo (Budget budget)
        {
            // verify the required parameter 'budget' is set
            if (budget == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'budget' when calling BudgetsApi->StoreBudget");
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitSingle> localVarResponse = StoreBudgetLimitWithHttpInfo(id, budgetLimit);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< BudgetLimitSingle > StoreBudgetLimitWithHttpInfo (int id, BudgetLimit budgetLimit)
        {
            ...
            if (budgetLimit == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'budgetLimit' when calling BudgetsApi->StoreBudgetLimit");
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitSingle> localVarResponse = await StoreBudgetLimitAsyncWithHttpInfo(id, budgetLimit);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetSingle> localVarResponse = UpdateBudgetWithHttpInfo(id, budget);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< BudgetSingle > UpdateBudgetWithHttpInfo (int id, Budget budget)
        {
            ...
            // verify the required parameter 'budget' is set
            if (budget == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'budget' when calling BudgetsApi->UpdateBudget");
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetSingle> localVarResponse = await UpdateBudgetAsyncWithHttpInfo(id, budget);
             return localVarResponse.Data;
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitSingle> localVarResponse = UpdateBudgetLimitWithHttpInfo(id, budgetLimit);
             return localVarResponse.Data;
        }
        ...
        public FireflyIII.Client.ApiResponse< BudgetLimitSingle > UpdateBudgetLimitWithHttpInfo (int id, BudgetLimit budgetLimit)
        {
            ...
            // verify the required parameter 'budgetLimit' is set
            if (budgetLimit == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'budgetLimit' when calling BudgetsApi->UpdateBudgetLimit");
        ...
        {
             FireflyIII.Client.ApiResponse<BudgetLimitSingle> localVarResponse = await UpdateBudgetLimitAsyncWithHttpInfo(id, budgetLimit);
             return localVarResponse.Data;
