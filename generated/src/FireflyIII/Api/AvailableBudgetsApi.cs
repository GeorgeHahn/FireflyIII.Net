...
namespace FireflyIII.Api
{
    ...
    public partial class AvailableBudgetsApi : IAvailableBudgetsApi
    {
        ...
        {
             FireflyIII.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = await GetAvailableBudgetAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="end">A date formatted YYYY-MM-DD.  (optional)</param>
        /// <returns>ApiResponse of AvailableBudgetArray</returns>
        public FireflyIII.Client.ApiResponse< AvailableBudgetArray > ListAvailableBudgetWithHttpInfo (int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?))
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
             FireflyIII.Client.ApiResponse<AvailableBudgetArray> localVarResponse = await ListAvailableBudgetAsyncWithHttpInfo(page, start, end);
             return localVarResponse.Data;
        ...
        /// <param name="end">A date formatted YYYY-MM-DD.  (optional)</param>
        /// <returns>Task of ApiResponse (AvailableBudgetArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<AvailableBudgetArray>> ListAvailableBudgetAsyncWithHttpInfo (int? page = default(int?), DateTime? start = default(DateTime?), DateTime? end = default(DateTime?))
        {
        ...
        /// <param name="availableBudget">JSON array or key&#x3D;value pairs with the necessary available budget information. See the model for the exact specifications.</param>
        /// <returns>ApiResponse of AvailableBudgetSingle</returns>
        public FireflyIII.Client.ApiResponse< AvailableBudgetSingle > StoreAvailableBudgetWithHttpInfo (AvailableBudget availableBudget)
        {
        ...
        {
             FireflyIII.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = await StoreAvailableBudgetAsyncWithHttpInfo(availableBudget);
             return localVarResponse.Data;
        ...
        /// <param name="availableBudget">JSON array or key&#x3D;value pairs with the necessary available budget information. See the model for the exact specifications.</param>
        /// <returns>Task of ApiResponse (AvailableBudgetSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<AvailableBudgetSingle>> StoreAvailableBudgetAsyncWithHttpInfo (AvailableBudget availableBudget)
        {
            // verify the required parameter 'availableBudget' is set
            if (availableBudget == null)
                throw new FireflyIII.Client.ApiException(400, "Missing required parameter 'availableBudget' when calling AvailableBudgetsApi->StoreAvailableBudget");
        ...
        {
             FireflyIII.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = await UpdateAvailableBudgetAsyncWithHttpInfo(id, availableBudget);
             return localVarResponse.Data;
